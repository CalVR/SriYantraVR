...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        // Added for SriYantra
        [SerializeField] private YantraController m_YantraController; 
        ...
        {
            // added for SriYantra
            m_YantraController.isOverButton = false;
            ...
            if (Physics.Raycast(ray, out hit, m_RayLength, ~m_ExclusionLayers))
            {
                ...
                // added for SriYantra
                if (hit.transform.gameObject.GetComponent<SelectionSlider>() != null) {
                    m_YantraController.isOverButton = true;
                }
            }
            else
            {
                ...
                if (m_Reticle)
                    ...
                    // the above is changed to the below for Oculus Go
